...
export default function AdminDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex font-sans">
      ...
      {/* Sidebar Navigation */}
      <aside className="w-64 bg-white shadow-xl fixed h-full z-20 flex flex-col transition-transform duration-300 ease-in-out transform">
        ...
        <nav className="flex-1 p-4 space-y-2 overflow-y-auto">
          <button
            ...
            className={`w-full text-left px-4 py-3 rounded-xl font-medium transition-all duration-200 flex items-center gap-3 ${activeTab === 'stats' ? 'bg-purple-50 text-purple-700 shadow-sm ring-1 ring-purple-100' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900 hover:shadow-sm'
              }`}
          >
          ...
          <button
            ...
            className={`w-full text-left px-4 py-3 rounded-xl font-medium transition-all duration-200 flex items-center gap-3 ${activeTab === 'users' ? 'bg-purple-50 text-purple-700 shadow-sm ring-1 ring-purple-100' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900 hover:shadow-sm'
              }`}
          >
            <span className="text-xl">👥</span>
          ...
          <button
            ...
            className={`w-full text-left px-4 py-3 rounded-xl font-medium transition-all duration-200 flex items-center gap-3 ${activeTab === 'transactions' ? 'bg-purple-50 text-purple-700 shadow-sm ring-1 ring-purple-100' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900 hover:shadow-sm'
              }`}
          >
            <span className="text-xl">💰</span>
          ...
          <button
            ...
            className={`w-full text-left px-4 py-3 rounded-xl font-medium transition-all duration-200 flex items-center gap-3 ${activeTab === 'messages' ? 'bg-purple-50 text-purple-700 shadow-sm ring-1 ring-purple-100' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900 hover:shadow-sm'
              }`}
          >
            <span className="text-xl">💬</span>
            <span>Messages</span>
        ...
        <div className="p-4 border-t border-gray-100 bg-gray-50/50">
          <button
            ...
            className="w-full text-left px-4 py-3 rounded-xl font-medium text-red-600 hover:bg-red-50 hover:shadow-sm transition-all duration-200 flex items-center gap-3 group"
          >
      ...
      <main className="flex-1 ml-64 min-h-screen flex flex-col bg-gray-50">
        <header className="bg-white/80 backdrop-blur-md shadow-sm px-8 py-4 flex justify-between items-center sticky top-0 z-10 border-b border-gray-100">
          <div>
            <h2 className="text-xl font-bold text-gray-800 capitalize">
              {activeTab === 'stats' && 'Dashboard Overview'}
              {activeTab === 'users' && 'Master Database'}
          ...
          <div className="flex items-center gap-4">
            <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-purple-100 to-blue-100 flex items-center justify-center text-purple-700 font-bold shadow-sm border border-white">
              A
            </div>
          </div>
        </header>
        ...
        <div className="p-8 flex-1 overflow-auto">
          ...
          {activeTab === 'messages' && (
            <div className="flex flex-col h-[calc(100vh-10rem)]">
              <div className="flex-1 bg-white rounded-3xl shadow-lg overflow-hidden border border-gray-200 flex flex-col">
                <div className="p-6 border-b border-gray-100 bg-gray-50/50">
                  <h2 className="text-xl font-bold text-gray-800">Communication Center</h2>
                  <p className="text-sm text-gray-500">Manage all your conversations in one place</p>
                </div>
